    ...
    <div className={`position-relative`}>
      ...
      <div className={`${style.products} position-relative d-flex flex-column justify-content-center align-items-center `}>
        <div className={`container`}>
          <div>
            <div className={` d-flex flex-column justify-content-between   ${style.box}`}>
              <diV>
              <div className={`d-flex flex-wrap justify-content-between align-items-center border-bottom gap-2 row-gap-2`}>
              
              <h1 className={`py-2 px-3  DancingScriptFont color1 ${style.category} border-bottom`}>{name }</h1>
              ...
              <div className={`${style.cards} d-flex justify-content-start gap-4 pt-4 pb-5 flex-wrap align-items-stretch row-gap-4 `}>
