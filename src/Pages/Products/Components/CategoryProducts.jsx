    ...
    <div className={`position-relative`}>
      ...
      >
        <div className={`container`}>
          <div>
            <div
              className={` d-flex flex-column justify-content-between   ${style.box}`}
            >
              <diV>
                <div
                ...
                {products.length == 0 ? (
                  <span className={`ps-5 color1 fs-5 CrimsonTextFont`}>
                    No products yet
                  </span>
                ) : (
                  <></>
              ...
              <div
                className={`${style.cards} d-flex justify-content-start gap-4 pt-4 pb-5 flex-wrap align-items-stretch row-gap-4 `}
              >
                {products.map((product) => (
                  ...
                  >
                    ...
                    />
                    <h5
                      className={`CrimsonTextFont text-center flex-grow-1 ${style.text}`}
                    >
                      {" "}
                      {product.name}
                    </h5>
